...
<script type="text/javascript" src="https://cdn.datatables.net/buttons/1.6.1/js/buttons.bootstrap4.min.js"></script>"></script>
...
<script type="text/javascript">
	$(document).ready(function() {
	   $('#notif-bells').click(function() {
			$('#notif-panel').toggle('fast');
		});
	});
</script>