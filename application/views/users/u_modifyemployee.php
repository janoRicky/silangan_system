											...
											<div class="form-group col-sm-12 col-md-4">
												...
												<div class="radio form-control">
													<label class="radio-inline">
														<input type="radio" name="Overtime" value="Yes" <?php if ($Overtime == 'Yes') echo 'checked'; ?>> Yes
													</label>
													<label class="radio-inline">
														<input type="radio" name="Overtime" value="No" <?php if ($Overtime == 'No') echo 'checked'; ?>> No
													</label>
												</div>
											</div>
											<div class="form-group col-sm-12 col-md-4">
												...
												<div class="radio form-control">
													<label class="radio-inline">
														<input type="radio" name="Reassignment" value="Yes" <?php if ($Reassignment == 'Yes') echo 'checked'; ?>> Yes
													</label>
													<label class="radio-inline">
														<input type="radio" name="Reassignment" value="No" <?php if ($Reassignment == 'No') echo 'checked'; ?>> No
													</label>
												</div>
											</div>
										</div>
